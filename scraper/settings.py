...
if SCRAPER_MODE not in {"search", "review", "update", "connections", "names"}:
...
GEOCODE_USE_GROQ_FALLBACK = _env_bool("GEOCODE_USE_GROQ_FALLBACK", True)
...
if MAX_DELAY < MIN_DELAY:
    ...
    MAX_DELAY = 240
GUI_MAX_PROFILES = 0
GUI_MAX_PROFILES = max(0, _env_int("GUI_MAX_PROFILES", GUI_MAX_PROFILES))
GUI_MAX_RUNTIME_MINUTES = max(0, _env_int("GUI_MAX_RUNTIME_MINUTES", 0))
